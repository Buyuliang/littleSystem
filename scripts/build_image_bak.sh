...
# sudo mount /home/tom/project/tmp/az04-buildroot/buildroot/output/rockchip_rk3588/images/rootfs.ext2 /mnt/buildroot
...
# # sudo rsync -a --delete $TOP_DIR/build/alpine/* ${MOUNT_POINT}/_rootfs -a
...
# Add padding to the end of the image to ensure enough space for the GPT
dd if=/dev/zero bs=$BLOCK_SIZE count=$((PAD_SIZE / BLOCK_SIZE)) >> "$OUTPUT_IMG"
